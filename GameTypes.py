class GameTypes:
    ...
    def play_game3(self):
        while True:
            ...
            if white_moves:
                new_cell_white = self.algorithms.select_the_prevented('white')
                self.actions.flip_the_cell('white', new_cell_white,0)
                self.view.print_board()
            else:
    ...
    def play_game3new(self):
            ...
            # Define the behavior based on the level
            if level1 == '1':
                bot_strategy1 = self.algorithms.select_random  # Beginner bot
            elif level1 == '2':
                bot_strategy1 = self.algorithms.select_the_best_next  # Semi-pro bot
            elif level1 == '3':
                bot_strategy1 = self.algorithms.select_the_prevented  # Professional bot
            elif level1 == '4':
                bot_strategy1 = self.algorithms.select_the_best_next  # World-class bot
            else:
                print("Invalid input. Defaulting to Beginner bot.")
                bot_strategy1 = self.algorithms.select_random

            # Define the behavior based on the level
            if level2 == '1':
                bot_strategy2 = self.algorithms.select_random  # Beginner bot
            elif level2 == '2':
                bot_strategy2 = self.algorithms.select_the_best_next  # Semi-pro bot
            elif level2 == '3':
                bot_strategy2 = self.algorithms.select_the_prevented  # Professional bot
            elif level2 == '4':
                bot_strategy2 = self.algorithms.select_the_best_next  # World-class bot
            else:
                print("Invalid input. Defaulting to Beginner bot.")
                bot_strategy2 = self.algorithms.select_random
            ...
            while True:
                ...
                if new_cell_black is None:
                    ...
                    self.actions.flip_the_cell('white', new_cell_black,1)
                    self.view.print_board()
                ...
                if new_cell_white is None:
                    ...
                    self.actions.flip_the_cell('white', new_cell_white,1)
                    self.view.print_board()
